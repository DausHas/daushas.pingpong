...
function showScreen() {
    if (playerScore == winingScore) {
        endGame();
        ctx.fillStyle = "#dedfdd";
        ctx.font = "20px open sans";
        ctx.fillText("YOU WIN!", cw / 2 - 120, ch / 2 - 100);
        showGameOverBtn();
        ...
        ctx.fillStyle = "#dedfdd";
        ctx.font = "20px open sans";
        ctx.fillText("YOU LOSE", cw / 2 - 120, ch / 2 - 100);
        showGameOverBtn();
...
function welcomeGame() {
    ...
    clickKey();
    //background opacity
    ctx.fillStyle = ctx.fillStyle = "#364f6b";
    ctx.fillRect(0, 0, 1000, 500);
    //text canvas
    ctx.fillStyle = "#dedfdd";
    ctx.font = "60px open sans";
    ctx.fillText("press Spacebar to play.", cw / 2 - 300, ch / 2);
    gameOverMenu = document.getElementById('gameOverMenu');
    againBtn = document.getElementById('againBtn');
